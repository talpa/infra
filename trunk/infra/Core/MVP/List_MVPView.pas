...
uses
  ...
  InfraMVPIntf, InfraBasicList, ReferenceImpl;
...
type
  ...
  TMVPViewList = class(_ITERABLELIST_)
  protected
...
function TMVPViewList.Add(const Item: _ITEM_INTF_): Integer;
begin
...
function TMVPViewList.Remove(const Item: _ITEM_INTF_): Integer;
begin
  Item.ParentView := nil;
  Result := inherited Remove(Item);
end;

procedure TMVPViewList.Clear;
var
...
procedure TMVPViewList.Delete(Index: Integer);
begin
  (Items[Index] as _ITEM_INTF_).ParentView := nil;
  inherited Delete(Index);
end;

procedure TMVPViewList.Insert(Index: Integer; const Item: _ITEM_INTF_);
begin
