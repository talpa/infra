...
type
  IInfraAspect = interface(IElement)
    ...
    procedure After(const Sender: IElement; const Params: IInfraList);
    procedure Before(const Sender: IElement; const Params: IInfraList);
  end;
  ...
  // Uses when registering pointcuts using logical string expressions
